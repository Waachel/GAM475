...
//---------------------------------------------------------------------------
TEST(Add4Allocs_RemoveAll_TrackingThroughHeap_Global, TestConfig::VERSION_CHECK)
{
#if Add4Allocs_RemoveAll_TrackingThroughHeap_Global
	...
	CHECK(strcmp(t0->GetFileName(), "Add4Allocs_RemoveAll_TrackingThroughHeap_Global.cpp") == 0);
	...
	CHECK(strcmp(t1->GetFileName(), "Add4Allocs_RemoveAll_TrackingThroughHeap_Global.cpp") == 0);
	...
	CHECK(strcmp(t2->GetFileName(), "Add4Allocs_RemoveAll_TrackingThroughHeap_Global.cpp") == 0);
	...
	CHECK(strcmp(t3->GetFileName(), "Add4Allocs_RemoveAll_TrackingThroughHeap_Global.cpp") == 0);
