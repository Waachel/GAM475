...
TEST(test1_trackCheck2, TestConfig::VERSION_CHECK)
{
#if test1_trackCheck2	
	...
	CHECK(strcmp(Tcurr->GetFileName(), "TrackCheck2.cpp") == 0);
	CHECK(Tcurr->GetGlobalNext() != nullptr);
	CHECK(Tcurr->GetGlobalPrev() == nullptr);
	CHECK(Tcurr->GetLineNum() == 66);
