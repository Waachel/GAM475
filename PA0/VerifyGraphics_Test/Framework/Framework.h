...
#pragma warning( disable : 4191 ) // Prefer 'enum class' over 'enum' (Enum.3)
#pragma warning( disable : 5246 ) // Prefer 'enum class' over 'enum' (Enum.3)
#pragma warning( disable : 5264 ) // Prefer 'enum class' over 'enum' (Enum.3)
