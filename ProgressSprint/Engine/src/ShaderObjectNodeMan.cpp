	...
	: ManBase(new DLinkMan(), new DLinkMan(), reserveNum, reserveGrow)
{
	...
	this->poNodeCompare->Set(ShaderObject::Name::NullShader, pShaderObject);
}
...
ShaderObjectNode *ShaderObjectNodeMan::Add(ShaderObject::Name name, ShaderObject *pMesh)
{
	ShaderObjectNodeMan *pMan = ShaderObjectNodeMan::privGetInstance();
...
ShaderObjectNode *ShaderObjectNodeMan::Find(ShaderObject::Name _name)
{
	ShaderObjectNodeMan *pMan = ShaderObjectNodeMan::privGetInstance();
	assert(pMan != nullptr);
