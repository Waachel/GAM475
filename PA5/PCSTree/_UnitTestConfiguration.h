...
// Keenan - stubbed out secret testing - leave false

	#define Keenan_A_Enable  true
	#define Keenan_B_Enable  true
	#define Keenan_C_Enable  true
	#define Keenan_D_Enable  true
